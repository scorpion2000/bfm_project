...
_rndReinforceHigh = floor (random 100);

if (_rndReinforceHigh < (25 + (missionNamespace getVariable "opf_reservesRegularCount")) || (missionNamespace getVariable "opf_reservesRegularCount") > 45) then {
