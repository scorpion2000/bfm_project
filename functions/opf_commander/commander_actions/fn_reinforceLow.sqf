...
if (_rndReinforceLow < (25 + (missionNamespace getVariable "opf_reservesRegularCount")) || (missionNamespace getVariable "opf_reservesRegularCount") > 45) then {
	...
	_rndReinforceCount = floor (random 20);
